package ConstrainSkyline.Approximate.mixed;
...
public class ApproxMixed {
    ...
    public ApproxMixed(int graph_size, int degree, int dimension, double range, int hotels_num, int obj_dimension, double distance_threshold) {
        this.range = range;
...
//                System.out.println(v.id);
                ...
                path[] needToProcess = new path[constant.path_dimension];
