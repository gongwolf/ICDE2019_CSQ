...
public class Skyline {
    public ArrayList<Data> skylineStaticNodes = new ArrayList<>(); // the list of POIs that are dominated by a given query points
    public ArrayList<Data> allNodes = new ArrayList<>();
    public ArrayList<Data> sky_hotels = new ArrayList<>(); // the skyline objects of a given list of POIs
